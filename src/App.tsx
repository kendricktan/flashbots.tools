...
function App() {
  const { address, connect, provider, signer } = Connection.useContainer();
            ...
            <Col>
              ...
              >
                <Text h5>
                  ...
                  <Tooltip
                    type="secondary"
                    text={"Recipient of the ERC20 tokens"}
                  >
                    <QuestionCircle size={15} />
                  </Tooltip>
                </Text>
              ...
              <Row align="middle" justify="center" style={{ height: "100%" }}>
                <Col style={{ width: "100%", textAlign: "center" }}>
                  {rescuingState === TransferERC20Progress.NotStarted && (
                    <>
                      <Text b>
                        Rescue your ERC20 from a compromised wallet!
                      </Text>
                      <Spacer y={0.1} />
